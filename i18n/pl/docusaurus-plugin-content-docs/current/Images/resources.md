...
Pole inżynierii podpowiedzi obrazu jest bardzo zróżnicowane. Tutaj jest dobra lista
zasobów, które obejmują część z nich.

- Lista zasobów](https://dallery.gallery/prompt-resources-tools-ai-art/) z Galerii DALLE
- Prompt Book dotyczący dyfuzji stabilnej](https://cdn.openart.ai/assets/Stable%20Diffusion%20Prompt%20Book%20From%20OpenArt%2010-28.pdf)
...
- [/r/PromptSharing na Reddit](https://www.reddit.com/r/PromptSharing/)
...
- Lexica, baza obrazów AI](https://lexica.art)
- [Playground, kolejna baza obrazów AI](https://playgroundai.com)
